...
+ (void) load{
    ...
    dispatch_once(&onceToken, ^{
        [self safe_swizzleMethod:@selector(SKperformSelector:) tarSel:@selector(performSelector:)];
        [self safe_swizzleMethod:@selector(SKperformSelector:withObject:) tarSel:@selector(performSelector:withObject:)];
        [self safe_swizzleMethod:@selector(SKperformSelector:withObject:withObject:) tarSel:@selector(performSelector:withObject:withObject:)];
    });
...
//    static dispatch_once_t onceToken;
//    dispatch_once(&onceToken, ^{
//        [self safe_swizzleMethod:@selector(SKsetValue:forKey:) tarSel:@selector(setValue:forKey:)];
//        [self safe_swizzleMethod:@selector(SKsetValue:forKeyPath:) tarSel:@selector(setValue:forKeyPath:)];
//        [self safe_swizzleMethod:@selector(SKsetValue:forUndefinedKey:) tarSel:@selector(setValue:forUndefinedKey:)];
//
//        [self safe_swizzleMethod:@selector(SKvalueForKey:) tarSel:@selector(valueForKey:)];
//        [self safe_swizzleMethod:@selector(SKvalueForKeyPath:) tarSel:@selector(valueForKeyPath:)];
//        [self safe_swizzleMethod:@selector(SKvalueForUndefinedKey:) tarSel:@selector(valueForUndefinedKey:)];
//    });
//
//}
@end
